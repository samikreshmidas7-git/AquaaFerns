...
const Home = () => {
  ...
  const [announcement, setAnnouncement] = useState({
    text: "Welcome to AquaaFerns! Check out our new collection of tropical fish!",
    isVisible: true,
    isEditing: false
  });
